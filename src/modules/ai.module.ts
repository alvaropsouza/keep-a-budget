...
@Module({
  ...
  providers: [AiService, PaymentMethodRepository, CategoryRepository, ParseExpenseUseCase, ParseExpenseImagesUseCase, ParseIrReceiptUseCase, ParseStockTicketUseCase],
})
